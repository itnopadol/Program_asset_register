 ...
 <div class=" container-scroller">
    ...
    <nav class="navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <li class="nav-item">
         <button class="btn btn-default" type="submit" id="sizezi2"  method="post" action="report_take.php"><a href="report_take.php?keyword=<?php echo $keyword; ?>" target="_blank"><img src='../../images/doc.png'  width='30'  height='30' >พิมพ์</a></button>
        </li>
...
//วนลูปแสดงลิงค์หมายเลขหน้า ตามจำนวนหน้า
	...
	$back=$page_id-1;
 	if($page_id>1){//ถ้า$page มากกว่า 1 ให้แสดงหน้าก่อนหน้า
		echo "<span><a href='report_take1.php?page_id=$back&keyword=$keyword'>ก่อนหน้า...</a></span>";
		}
		 for($id=1;$id<=$page;$id++){
  ...
  echo"<span style='color:back;'><a href='report_take1.php?page_id=$id&keyword=$keyword'>[ $id ]</a></span> ";
      }
}

		if($page!=$page_id){//ถ้า$page ไม่เท่ากับ $page_id ให้แสดงหน้าถัดไป
			    echo "<span><a href= 'report_take1.php?page_id=$go&keyword=$keyword'>...หน้าถัดไป</a></span>";
			  }
	}
