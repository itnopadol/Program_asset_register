 ...
 <div class=" container-scroller">
    ...
    <nav class="navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <li class="nav-item">
         <button class="btn btn-default" type="submit" id="sizezi2"  method="post" action="report_send.php"><a href="report_send.php?keyword=<?php echo $keyword; ?>" target="_blank"><img src='../../images/doc.png'  width='30'  height='30' >พิมพ์</a></button>
        </li>
...
<?php
	...
	$result2 = mysqli_query($con, "SELECT * FROM send_sp  WHERE  send_id  LIKE '%$keyword%' OR send_bill LIKE '%$keyword%' OR send_nameSp  LIKE '%$keyword%'  ORDER BY send_id   ASC LIMIT $start_rows,$rowspage")or die("SQL Error2".mysqli_error($con));
	
	$result3 = mysqli_query($con,"SELECT rent_empID,rent_name,rent_department FROM lend_empsp WHERE rent_empID LIKE '%$keyword%' OR rent_empID LIKE '%$keyword%' OR rent_name") 
