...
<body>
  <div class=" container-scroller">
	...
	$result2 = mysqli_query($con,"SELECT * FROM send_sp WHERE send_id  LIKE '%$keyword%' OR send_bill LIKE '%$keyword%' 
	OR send_nameSp LIKE '%$keyword%' ORDER BY send_id ASC LIMIT $start_rows,$rowspage")or die("SQL Error2".mysqli_error($con)); 
	$num=1;
