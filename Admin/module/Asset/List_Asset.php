...
<body>
  <div class=" container-scroller">
	...
	while(list($Asset_id,$Asset_code ,$Asset_serial ,$Asset_name ,$mac_address,$computer_name
		...
		echo "<td><a href='index.php?module=2&action=25&id=$Asset_id' title='รายละเอียด!'>$Asset_name</td>";
		echo "<td>$brand</td>";
		echo "<td><a href='index.php?module=2&action=9&Asset_id=$Asset_id' onclick='return confirm(\"กดปุ่ม ตกลงเพื่อยืนยันการแก้ไขข้อมูล\")'>
		<img src='../../images/if_brush-pencil.png'  width='30'  height='30'></td>";
		echo "<td><a href='index.php?module=2&action=10&Asset_id=$Asset_id' onclick='return confirm(\"กดปุ่ม ตกลงเพื่อยืนยันการลบข้อมูล\")'>
