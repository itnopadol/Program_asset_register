...
<?php
	...
	$result2 = mysqli_query($con,"SELECT * FROM spare_part WHERE  name  LIKE '%$keyword%' OR category LIKE '%$keyword%'OR brand ORDER BY id 
	ASC LIMIT $start_rows,$rowspage") or die ("MySQL =>".mysqli_error($con));
