 ...
 <div class=" container-scroller">
    ...
    <nav class="navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <li class="nav-item">
         <button class="btn btn-default" type="submit" id="sizezi2"  method="post" action="report_lend.php"><a href="report_lend.php?keyword=<?php echo $keyword; ?>" target="_blank"><img src='../../images/doc.png'  width='30'  height='30' >พิมพ์</a></button>
        </li>
...
<?php
	...
	$result1 = mysqli_query($con,"SELECT lend_spare.*,lend_empsp.rent_name FROM lend_spare Left JOIN lend_empsp ON lend_spare.rent_empID=lend_empsp.rent_empID  WHERE name	LIKE '%$keyword%' OR name LIKE '%$keyword%' OR lend_empsp.rent_name  LIKE '%$keyword%' OR lend_spare.Order_lend LIKE '%$keyword%' OR detail  LIKE '%$keyword%' OR lend_spare.category_lend LIKE '%$keyword%' GROUP BY lend_spare.No ORDER BY lend_spare.No ASC")or die(mysqli_error($result1));
	...
	$result2= mysqli_query($con,"SELECT lend_spare.*,lend_empsp.rent_name FROM lend_spare Left JOIN lend_empsp ON lend_spare.rent_empID=lend_empsp.rent_empID  WHERE name	LIKE '%$keyword%' OR name LIKE '%$keyword%' OR lend_empsp.rent_name  LIKE '%$keyword%' OR lend_spare.Order_lend LIKE '%$keyword%' OR detail  LIKE '%$keyword%' OR lend_spare.category_lend LIKE '%$keyword%' GROUP BY lend_spare.No ORDER BY lend_spare.No ASC LIMIT $start_rows,$rowspage")or die("SQL Error2".mysqli_error($con));
