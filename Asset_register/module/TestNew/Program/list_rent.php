...
มีทั้งหมด $rows รายการ </p>";
	...
	while(list($rent_id,$name,$brand,$stock ,$receive,$pay
	...
	echo "<td align='center'>$receive</td>";
	echo "<td align='center'>$pay</td>";
	echo "<td align='center'>$balance</td>";
	echo "<td align='center'><a href='edit_form.php?rent_id=$rent_id'><img src='../img/if_pencil_10550.png'  width='30'  height='30'></TD>";
