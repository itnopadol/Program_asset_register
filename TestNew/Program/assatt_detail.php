...
<?php
	...
	list($Asset_id,$Asset_code,$Asset_seria,$Asset_name,$mac_address,$computer_name,$brand,$Asset_receivr_amou,$Asset_date,$Asset_company,$Asset_price,$Asset_barcode,$Category_id,$Asset_photo,$Asset_time,$detail	)=mysqli_fetch_row($result);
	...
	echo"จำนวน  : $Asset_receivr_amou</p>";
