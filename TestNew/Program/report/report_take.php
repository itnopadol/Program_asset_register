...
<body style="font-family:'TH Sarabun New', 'Tw Cen MT'">
    ...
    <h4 align="center"><P>ประจำเดือน มกราคม 2561</P></h4>
     ...
     <?php
	$result = mysqli_query($con,"SELECT take_id,id_inventory,take_name,take_brand,take_pice,take_category,take_acquire,take_time FROM take ORDER BY take_name")or die(mysqli_error($con));
